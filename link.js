...
/*Arvin 
Update alarm to homepage*/
var alarmList = []
function updateHomeAlarm(){
 document.querySelector("#firstAlarm").textContent = alarmList[0];
 document.querySelector("#secondAlarm").textContent = alarmList[1];
}
